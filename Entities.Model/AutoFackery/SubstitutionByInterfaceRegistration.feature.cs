...
#line 1 "SubstitutionByInterfaceRegistration.feature"
#line hidden
...
#line hidden
        ...
        [NUnit.Framework.TestAttribute()]
        [NUnit.Framework.DescriptionAttribute("Take a component and execute it using another configuration substituting by inter" +
            "face")]
        public virtual void TakeAComponentAndExecuteItUsingAnotherConfigurationSubstitutingByInterface()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Take a component and execute it using another configuration substituting by inter" +
                    "face", ((string[])(null)));
#line 9
this.ScenarioSetup(scenarioInfo);
#line hidden
