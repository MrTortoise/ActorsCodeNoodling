...
namespace Entities.Model.AutoFackery
{
    ...
    [NUnit.Framework.DescriptionAttribute("InstancePerFeaturePart1")]
    [NUnit.Framework.CategoryAttribute("Autofackery")]
    public partial class InstancePerFeaturePart1Feature
    {
        
        private TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "InstancePerFeature.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "InstancePerFeaturePart1", "\tIn order to share expensive configuration accross scenarios\r\n\tAs a lazy dev\r\n\tI " +
                    "want to be able to check an iterator continues accross scenarios", ProgrammingLanguage.CSharp, new string[] {
                        "Autofackery"});
